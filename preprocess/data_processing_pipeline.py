...
def data_processing_pipeline(video_file: str, output_dir: str, scene_threshold: float = 2.0, num_workers: int = 1):
    ...
    split_video_into_scenes(fps_video_file, detect_scene_output_dir, scene_threshold)
